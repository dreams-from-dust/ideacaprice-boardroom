...
export default function AuthModal({ isOpen, onClose, onAuthSuccess }: AuthModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-50 flex items-center justify-center p-4 overflow-y-auto overflow-x-hidden invisible-scrollbar" id="auth-modal-screen">
      <div className="relative bg-charcoal border-2 border-charcoal-light w-full max-w-md p-6 md:p-8 rounded-[2rem] shadow-2xl overflow-y-auto overflow-x-hidden max-h-[90vh] my-8 font-sans invisible-scrollbar">
